...
export default function Headers(){
    ...
    <Row style={{minHeight:'100vh'}}>
        <Col className="col-header">
            <div>
                <div className="text-5xl text-left">Dapatkan Informasi Terbaru Untuk Hari-Harimu</div>
                <Link to="beranda" activeClass="active" spy='true' smooth='true' offset={-70} duration={500} >
                    <Button variant="outline-dark" className="btn-headers">Start Read</Button>
                </Link>
            </div>
        </Col>
        <Col className="m-2">
            ...
            {newsID.slice(0, 2).map((article, idx) => (
                ...
                <Card.Body>
                    ...
                    <a href={article.url}>
                        <Button variant="dark" style={{color:'black'}}>Go</Button>
                    </a>
                    </Col>
                    </Row>
                </Card.Body>
